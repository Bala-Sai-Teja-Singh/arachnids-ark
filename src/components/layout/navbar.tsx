            ...
            <>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-64 bg-card border-border shadow-xl mt-2 p-2 animate-in fade-in zoom-in-95 duration-200">
                  ...
                  {user.role === 'admin' && (
                    <DropdownMenuItem onClick={() => router.push('/admin')} className="gap-2 cursor-pointer text-brand-gold focus:bg-brand-gold/10 focus:text-brand-gold rounded-lg py-2">
